                    ...
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('admin.post.create') }}" class="btn btn-sm btn-primary">Add post</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <td class="text-right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                            <a class="dropdown-item" href="{{ route('admin.post.edit', ['post' => $post->id]) }}">Sửa</a>
                                            <a class="dropdown-item" href="{{ route('admin.post.destroy', ['post' => $post->id]) }}">Xóa</a>
                                        </div>
                                    </div>
                                </td>
                            </tr>
